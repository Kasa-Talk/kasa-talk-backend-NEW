...
const generateAccessToken = (user) => jsonWebToken.sign(user, process.env.JWT_SECERET, {
  expiresIn: process.env.JWT_EXPIRES_IN || '3600s',
});

const generateRefreshToken = (user) => jsonWebToken.sign(user, process.env.JWT_REFRESH_SECERET, {
